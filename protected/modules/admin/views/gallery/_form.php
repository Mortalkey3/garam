	...
	<div class="span4">
		...
		<div class="widgetbox block-rightcontent">                        
		    ...
		    <div class="widgetcontent">
				...
				'hint'=>'<b>Note:</b> Ukuran gambar adalah 362 x 362px. Gambar yang lebih besar akan ter-crop otomatis', 'style'=>"width: 100%")); ?>
				<?php if ($model->scenario == 'update'): ?>
		...
		<div class="widgetbox block-rightcontent">                        
		    ...
		    <div class="widgetcontent">
		    	...
		    	<p class="help-block"><b>Note:</b> Ukuran gambar adalah 362 x 362px. Gambar yang lebih besar akan ter-crop otomatis</p>
				<style>
