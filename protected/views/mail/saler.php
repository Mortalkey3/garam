                            ...
                            <tbody>
                                <tr style="margin:0;padding:0">
                                    <td style="margin:0;padding:0">
                                        ...
                                        <p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Berikut ini data diri yang anda kirimkan kepada <span class="lG">UFO Elektronika</span>.</p>
                                ...
                                <tr style="margin:0;padding:0">
                                    <td valign="top" style="margin:0;padding:0 10px 0 0;width:75%">
                                        ...
                                        <span style="font-size:12px;margin-bottom:6px;display:inline-block">
                                        	<b>Hubungi <span class="lG">UFO Elektronika</span></b> <br>
                                ...
                                <tr style="margin:0;padding:0">
                                    ...
                                    */ ?>
                                    ...
                                    <td valign="middle" style="width:40%">
                                        ...
                                        <div style="text-align:right"><img alt="UFO Elektronika" style="max-width: 120px;" src="<?php echo $baseUrl ?>/asset/images/logo-linette-black.png">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
