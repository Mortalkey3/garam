                        ...
                        <table bgcolor="transparent" style="max-width:100%;border-collapse:collapse;border-spacing:0;width:100%;background-color:transparent;margin:0;padding:0">
                            <tbody>
                                <tr style="margin:0;padding:0">
                                    <td style="margin:0;padding:0">
                                        <?php if ($order == true): ?>
                                        <h5 style="line-height:24px;color:#000;font-weight:900;font-size:17px;margin:0 0 20px;padding:0">Thank you for order private label, we will contact you as soon as possible</h5>
                                        <?php else: ?>
                                        ...
                                        <?php endif ?>
                                        <p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Here's the message you send to <span class="lG">Cheetham Garam Indonesia</span>.</p>
                                        <div style="margin:0 0 20px;padding:0">
                                            ...
                                            <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                <tbody style="margin:0;padding:0">
                                                    <tr style="margin:0;padding:0">
                                                        ...
                                                        <td valign="top" style="font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0"><?php echo $model->body ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table bgcolor="transparent" style="width:100%;max-width:100%;border-collapse:collapse;border-spacing:0;background-color:transparent;margin:5px 0;padding:0">
                                                <tbody style="margin:0;padding:0">
                                                    <tr style="margin:0;padding:0">
                                                        <td valign="top" style="width:25%;font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0">CV:
                                                        </td>
                                                        <td valign="top" style="font-size:13px;vertical-align:top;line-height:18px;margin:0;padding:0 10px 0 0">
                                                            <a href="<?php echo $attachment ?>" target="_blank">Download CV</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tr style="margin:0;padding:0">
                                    <td valign="top" style="margin:0;padding:0 10px 0 0;width:75%">
                                        ...
                                        <span style="font-size:12px;margin-bottom:6px;display:inline-block">
                                            <b><?php echo Yii::t('mail', 'Hubungi') ?> <span class="lG">Cheetham Garam Indonesia</span></b> <br>
                                    ...
                                    */ ?>
                                    <td valign="middle" style="margin:0;padding:0;width:53%">
                                        ...
                                        <p style="color:#91908e;font-size:10px;line-height:150%;font-weight:normal;margin:0px;padding:0px"><?php echo Yii::t('mail', 'Jika butuh bantuan, gunakan halaman') ?> <a target="_blank" style="color:#0f990f;text-decoration:none;margin:0;padding:0" href="<?php echo $url.CHtml::normalizeUrl(array('/home/contact')); ?>"><?php echo Yii::t('mail', 'Kontak Kami') ?></a>.<br style="margin:0;padding:0"><?php echo date('Y') ?> &copy;
                                            ...
                                            <span class="lG">Cheetham Garam Indonesia</span></p>
                                    </td>
                                    <td valign="middle" style="width:40%">
                                        <div style="text-align:right"><img alt="Cheetham Garam Indonesia" style="max-width: 200px;" src="<?php echo $baseUrl ?>/asset/images/lgo_wb_headers-cheetham.jpg">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
