...
class Slide extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			// array('active', 'required', 'on'=>'insertProduct'),
			// array('active', 'required', 'on'=>'updateProduct'),

			array('active, topik_id', 'numerical', 'integerOnly'=>true),
			array('writer, image, insert_by, last_update_by', 'length', 'max'=>255),
			array('image, image2', 'file', 'types'=>'jpg, gif, png', 'allowEmpty'=>FALSE, 'on'=>'insert', 'maxSize'=>1024 * 1024 * 2, 'tooLarge'=>'File has to be smaller than 2MB'),
			array('image, image2', 'file', 'types'=>'jpg, gif, png', 'allowEmpty'=>TRUE, 'on'=>'update', 'maxSize'=>1024 * 1024 * 2, 'tooLarge'=>'File has to be smaller than 2MB'),
			// The following rule is used by search().
			array('hide_text', 'safe'),
			// Please remove those attributes that should not be searched.
			array('title, writer_name ,id, active, date_input, date_update, insert_by, last_update_by, hide_text', 'safe', 'on'=>'search'),
		);
	}
