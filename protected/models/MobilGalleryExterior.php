...
/**
 * This is the model class for table "mobil_gallery_exterior".
 *
 * The followings are the available columns in table 'mobil_gallery_exterior':
 * @property integer $id
 * @property integer $mobil_id
 * @property string $image
 */
class MobilGalleryExterior extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MobilGalleryExterior the static model class
	 */
